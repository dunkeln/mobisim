...
import type { FooterChatAudioResponse, FooterChatRequest } from './types';
...
export async function createFooterAudioChatResponse(
  ...
  try {
    ...
    return {
      ...
      audioMimeType: `audio/${DEFAULT_TTS_FORMAT}`,
      audioVoice: getSpeechVoice(),
      chat
    };
  } catch (error) {
